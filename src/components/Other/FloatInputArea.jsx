...
const FloatInputArea = ({type="text", placeholder="text",maxCharCount=100}) => {
    ...
    return (
        <>
          <FloatingLabel style={{width: '100%', height: '100%'}} id={redOutlines ? "RED" : "BLK"} controlId={"floatingInput"+{type}} label={placeholder + ((wordCount > 0 && maxCharCount > 0) ? (" ("+wordCount+"/"+maxCharCount+")") : "")}>
